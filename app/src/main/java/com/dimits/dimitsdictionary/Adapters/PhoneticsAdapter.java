package com.dimits.dimitsdictionary.Adapters;
...
import com.dimits.dimitsdictionary.Models.Phonetics;
import com.dimits.dimitsdictionary.R;
import com.dimits.dimitsdictionary.ViewHolders.PhoneticViewHolder;
        ...
        holder.imageButton_audio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    e.printStackTrace();
                    Toast.makeText(context, "Could not Play this", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
